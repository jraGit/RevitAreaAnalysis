...
export const DEFAULT_GROUP_PALETTE = ['#e6e6ff', '#d5d5d5', '#e2efe9', '#cfe4d9', '#ffffcc', '#a5a5a5', '#b4dabf', '#88aed9', '#aac6e3', '#feedfa', '#f5f5f5', '#ffc8c8', '#ffcb97', '#ffd9b3', '#eefbe7', '#dceeff', '#fff2cf', '#eadff7', '#f8e1de', '#d8f3f7'];
...
export const DEFAULT_AREA_GROUP_COLORS = {
  'AMENITIES': '#e6e6ff',
  'BOH / MEP': '#d5d5d5',
  'BRANDED RESI OTHER': '#e2efe9',
  'BRANDED RESIDENTIAL': '#cfe4d9',
  'CIRCULATION': '#ffffcc',
  'CORE': '#a5a5a5',
  'ENTERTAINMENT': '#edfae6',
  'EXTERIOR DECK': '#f2e6fa',
